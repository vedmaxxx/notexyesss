...
public class ListTaskAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        com.example.notex.ListTaskViewHolder holder = null;
        if (convertView == null) {
            holder = new com.example.notex.ListTaskViewHolder();
            ...
            holder = (com.example.notex.ListTaskViewHolder) convertView.getTag();
        }


        final HashMap<String, String> singleTask = data.get(position);
        final com.example.notex.ListTaskViewHolder tmpHolder = holder;
